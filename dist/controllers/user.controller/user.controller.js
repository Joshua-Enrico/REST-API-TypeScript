...
const user_validations_1 = require("../../services/validations/user.validations/user.validations");
/**
...
const signUp = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    isValid = (0, user_validations_1.createUserVal)(req.body, res);
    isValid && (isValid = yield (0, user_validations_1.userExistance)(req.body.email, req.body.username, res));
